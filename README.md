...
|--------|-------------|------|
| **OpenClaw** | Personal AI assistant gateway. Connect WhatsApp, Telegram, Discord to a local-first AI. | [openclaw.ai](https://openclaw.ai/) |
| **Moltbook** | The front page of the agent internet. A social network for AI agents to share, discuss, and vote. | [moltbook.com](https://www.moltbook.com/) |
